...
class ProjectSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['name' => 'My Portofolio', 'description' => 'Sebuah website sederhana yang menampilkan portofolio pribadi menggunakan bahasa pemograman Laravel','link_picture' => 'https://i.ibb.co/3WTJXM3/portfolio-1.png,https://i.ibb.co/jG7Yrzh/portfolio-2.png,https://i.ibb.co/LJPp3zV/portfolio-3.png', 'link_repo' => 'https://github.com/rizkiaprilan/Laravel---Cooking-Guide.git'],
        ];
    }
}
